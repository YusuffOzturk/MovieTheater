...
Movie Movie :: operator+(const Movie& m){
    Movie movie;
    movie.movie_name=this->movie_name+ m.movie_name;
    movie.ticket_price=this->ticket_price+m.ticket_price;
    movie.tickets_available=this->tickets_available+m.ticket_price;
    return movie;
